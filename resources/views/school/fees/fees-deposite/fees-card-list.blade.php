    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <a href="{{ url('school/print-report') . '/' . $student->id }}" class=" btn btn-primary" style="margin-left:20px;">Print All Receipts</a>
            ...
            <div class="student-group-form" id="searchlist">
                <form action="{{ route('search-fees-student-list') }}" method="get">
                    @csrf
                    {{-- <div class="row">
                        <div class=" col-md-5">
                    ...
                    <table class="table">
                        <thead class="table-success text-nowrap">
                            <tr style="">
                                ...
                                <th>Father Name</th>
                                <th>Mobile</th>
                                <th>Online Receipt No</th>
                                <th>Offline Receipt No</th>
                                <th>Paid Date</th>
                        ...
                        <tbody class="text-nowrap">
                            ...
                            @foreach ($unique as $key => $data)
                                <tr>
                                    ...
                                    <td>{{ $student->fee_account }}</td>
                                    <td>{{ $student->roll_no }}</td>
                                    <td>{{ $student->student_name }}</td>
                                    <td>{{ $student->father_name }}</td>
                                    <td>{{ $student->mobile }}</td>
                                    <td>{{ $data['online_receipt_no']}}</td>
                                    <td>{{ $data['reciept_no']}}</td>
                                    <td>{{\Carbon\Carbon::parse($data['date'])->format('d/m/y')  }}</td>

                                    <td class="action">

                                            <div class=" ">
                                                <a href="{{ url('school/print-single-report') . '/' . $data['id'] . '/' . $student->id }}"
