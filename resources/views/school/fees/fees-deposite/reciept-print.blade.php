    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid bg-white d-flex flex-column justify-content-center ">
            <div class="header-section">
                <a id="cancelbtn" href="{{ route('pendinglist') }}" class=" btn btn-primary mb-4"
            ...
            <div class="printbox">
                 <div class="print-header m-2 mt-0 mb-0 p-4 border border-primary">
                    <div class="school">
                    ...
                    <div class="middle-section mt-2 pt-0">
                        <div class="application" style="margin-top: -0px;">
                            ...
                            <div class="d-flex flex-row">
                                <h6 class="col-2"><span style="font-weight: 600;">Online Receipt No:</span></h6>
                            ...
                            <div class="d-flex flex-row">
                                <h6 class="col-2"><span style="font-weight: 600;">Offline Reciept No:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59); " class="col-3 text-center">
                                    {{ $feesdetails->receipt_no }}
                                </h6>
                        ...
                        <div class="content-name">
                            <div class="d-flex flex-row">
                                <h6 class="col-1"><span style="font-weight: 600;"> {{$student->locality_type}}:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59); " class="col-5 text-center">
                                    {{ $student->village }}
                                </h6>
                            ...
                            @endif
                            <div class="d-flex flex-row">
                                <h6 class="col-3" style=" margin-right:-20px;"><span style="font-weight: 600;">Reciever
                                        Name:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-3 text-center">
                                    {{ $feesdetails->reciever_name }}
                                </h6>
                                <h6 class="col-3" style="margin-left:20px;"><span style="font-weight: 600;">Depositor
                                        Code:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-3 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($feesTransaction as $key => $fees)
                                            ...
                                            @php
                                                ...
                                                $totalDepositeAmount = $totalDepositeAmount + $fees->fees_paid;
                    ...
                    <div class="middle-section mt-2 pt-0">
                        <div class="application" style="margin-top: -0px;">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <h6 class="col-2" style="margin-left:20px; margin-right:-20px;"><span
                                        style="font-weight: 600;">Account No:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-5 text-center">
                                    {{ $student->fee_account }}
                                </h6>
                            </div>
