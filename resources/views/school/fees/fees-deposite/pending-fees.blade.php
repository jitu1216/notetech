    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="student-group-form" id="searchlist">
                <form action="{{ route('feesearchpending') }}" method="get">
                    @csrf
                    <div class="row">
                        <div class=" col-md-5">
                    ...
                    <table class="table">
                        ...
                        <thead class="table-success text-nowrap">
                            <tr style="">
                                ...
                                <th></th>
                                <th></th>
                                <th id="totalamount" class="text-center">{{ $totalAmount }}</th>
                                <th id="totaldeposite" class="text-center">{{ $totalDeposite }}</th>
                                <th id="totalpending" class="text-center">{{ $totalPending }}</th>
