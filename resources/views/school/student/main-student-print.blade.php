    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid border border-primary ">
            <div class="header-section">
                <a id="cancelbtn" href="{{ URL::previous() }}" class=" btn btn-primary"
            ...
            <div class="print-header m-3">
                <div class="school">
                    ...
                    <div class="main-container">
                        ...
                        <p><span>Email.{{ Custom::getSchool()->Email }}</span> <span>Mobile No.
                            ...
                            {{-- <p style="margin-top: -18px;"><span>Session Year {{ Session::get('academic_session') }}</span> --}}
                        </p>
                ...
                <div class="top">
                    <div class="content">
                        ...
                        <h6 class="mb-4" style="font-weight:600;color: rgb(172, 0, 0) !important" >Student Information</h6>
                        {{--  <p style="">
                        ...
                        <div class="application">
                            <div class="d-flex flex-row">
                                <h6 class="col-3" style="margin-left:0px; margin-right:0px;"><span style="font-weight: 600;">Application No. :</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                                    {{ $student->application_no }}
                                </h6>
                                <h6 class="col-3" style="margin-left:25px; margin-right:0px;"><span style="font-weight: 600;">Application Date:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                        ...
                        <div class="application">
                            <div class="d-flex flex-row">
                                <h6 class="col-3" style="margin-left:0px; margin-right:0px;"><span style="font-weight: 600;">S.R. No. :</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                                    {{ $student->sr_no }}
                                </h6>
                                <h6 class="col-3" style="margin-left:25px; margin-right:0px;"><span style="font-weight: 600;">Admission Date:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                    ...
                    <div class="student-image" style="margin-top: 60px;">
                        <img src="{{ URL::to('student-photos') . '/' . $student->image }}" alt="" width="100"
                            height="130">
                    </div>
                </div>
                <div class="middle-section" style="margin-top: -50px;">
                    <div class="application">
                        <div class="d-flex flex-row">
                        ...
                        <div class="d-flex flex-row">
                            <h6 class="col-2"><span style="font-weight: 600;">Class:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59); " class="col-2 text-center">
                                {{ $schoolclass->classname }}
                            </h6>
                            <h6 class="col-2" style="margin-left: 30px; margin-right:0px;"><span style="font-weight: 600;">Roll No.:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                                {{ $student->roll_no }}
                            </h6>
                        ...
                        <div class="d-flex flex-row">
                            <h6 class="col-2" style="margin-left:0px; margin-right:0px;"><span style="font-weight: 600;">Date of Birth:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                                {{ $student->dob }}
                            </h6>
                            <h6 class="col-2" style="margin-left:25px; margin-right:0px;"><span style="font-weight: 600;">Session Year:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-2 text-center">
                                {{ Session::get('academic_session') }}
                            </h6>
                        </div>

                        {{-- <span style="font-weight:600;margin-right:22px;">Class. </span><span
                            style="border: 1px solid rgb(168, 168, 168); padding:4px;">&nbsp;&nbsp;{{ $schoolclass->classname }}&nbsp;&nbsp;</span>
                        <span style="font-weight:600;margin-left:22px;">Roll No. </span><span
                            style="border: 1px solid rgb(163, 163, 163); padding:4px;">&nbsp;&nbsp;{{ $student->roll_no }}&nbsp;&nbsp;</span>
                        <span style="font-weight:600;margin-left:22px;">Date of Birth </span><span
                            style="border: 1px solid rgb(167, 167, 167); padding:4px;">&nbsp;&nbsp;{{ $student->dob }}&nbsp;&nbsp;</span>
                            <span style="font-weight:600;margin-left:22px;">Session Year </span><span
                            style="border: 1px solid rgb(167, 167, 167); padding:4px;">&nbsp;&nbsp;{{ Session::get('academic_session') }}&nbsp;&nbsp;</span> --}}
                    </div>
                    <div class="content-name ">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <h6 class="col-2" style="margin-left:20px; margin-right:-20px;"><span style="font-weight: 600;">Mother Name:</span></h6>
                    ...
                    <div class="content-name ">
                        <div class="d-flex flex-row">
                            ...
                            <h6 class="col-2" style="margin-left:20px; margin-right:-20px;"><span style="font-weight: 600;">Gender:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-5 text-center">
                                {{ $student->gender }}
                            </h6>
                        </div>
                        {{-- <h6><span style="font-weight:600;">Aadhar No. </span><span
                                style="border: 1px solid rgb(173, 173, 173); padding:4px; width:120px !important;">&nbsp;&nbsp;&nbsp;&nbsp;{{ $student->aadhar_no }}&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <span style="font-weight:600;margin-left:50px;">Gender</span> <span
                                style="font-weight:600;margin-left:15px;">Male</span>
                            <span style="border: 1px solid rgb(167, 167, 167); padding:4px;">&nbsp;&nbsp;@if ($student->gender == 'Male')
                                    ✔
                                @endif&nbsp;&nbsp;</span>
                            <span style="font-weight:600;margin-left:50px;">Female</span>
                            <span style="border: 1px solid rgb(167, 167, 167); padding:4px;">&nbsp;&nbsp;@if ($student->gender == 'Female')
                                    ✔
                                @endif&nbsp;&nbsp;</span>
                        </h6> --}}
                    </div>
                    <div class="content-name">
                        <div class="d-flex flex-row">
                            ...
                            <h6 class="col-2" style="margin-left:20px; margin-right:-20px;"><span style="font-weight: 600;">Post/Town:</span></h6>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <h6 class="col-1" style="margin-left: 0px; margin-right: -20px;"><span style="font-weight: 600;">State:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-3 text-center">
                                    {{ $student->state }}
                                </h6>
                                <h6 class="col-1" style="margin-left:20px; margin-right:0px;"><span style="font-weight: 600;">Pincode:</span></h6>
                                <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-3 text-center">
                                    {{ $student->pincode }}
                                </h6>
                            </div>
                    ...
                    <div class="content-name">
                        <div class="d-flex flex-row">
                            ...
                            <h6 class="col-1" style="margin-left: 0px; margin-right: -20px;"><span style="font-weight: 600;">Caste:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-3 text-center">
                                {{ $student->caste }}
                            </h6>
                            <h6 class="col-1" style="margin-left:20px; margin-right:0px;"><span style="font-weight: 600;">Religion:</span></h6>
                            <h6 style="border-bottom:1px solid rgb(59, 59, 59);" class="col-3 text-center">
                                {{ $student->religion }}
                            </h6>
                        </div>
                    ...
                    <div class="content-name mt-3">
                        <h6 style="color: rgb(172, 0, 0) !important; padding:7px; background-color:rgb(189, 189, 189); font-weight:600;">
                    ...
                    <div class="content-name mt-3">
                        ...
                        <span class="">Your Faithfully
                        </span>
                    </div>
                    <div class="content-name mt-5 pt-5">
