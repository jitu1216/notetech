                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            type="text" name="occupation" placeholder="Enter Father Occupation"
                                    ...
                                    <div class="row bg-light pt-3 pb-2 mb-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('admission_date') }}" id="admission_date">
                                        ...
                                        <div class="col-4 sm-4 mt-4">
                                            <div class="student-submit">
                                                <input
                                                    ...
                                                    type="submit" class="" value="Approved Student">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4 sm-4 mt-4">
                                            <div class="student-submit">
                                                <input
                                                    ...
                                                    type="submit" class="" value="Reject Student">
                                            </div>
                                        </div>
                        ...
                        $.each(data, function(key, value) {
                            ...
                            if (subjects[key] == value.subject_name) {
                                ...
                                subject.append(
                                    ...
                                    value.id +
                                    '" type="checkbox" checked class="form-check-input" style="font-size: 30px; margin-top:15px;"></div></div>'
                                ); // return empty
                            } else {
                                subject.append(
                                    '<div class="col-2 col-sm-1 mainsubject"><div class="form-group local-forms"><label style="margin-left: -14px;">' +
