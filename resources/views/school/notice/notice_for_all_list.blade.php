                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="Info">
                                <a href="{{ 'add-notice-for-all' }}" class="btn btn-primary">
                                    <i class="fas fa-plus"></i>Add Notice</a>
                            </h3>
                            @if (session('status'))
                                    ...
                                    <tbody class=" wrap text-center">
                                        @foreach ($notice as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('notice-for-all', $value->id) }}"
                                                        class="btn btn-sm btn-success me-2"style=" color:white !important;">
                                                        <i class="feather-eye"></i></a>
                                                    <a href="{{ route('edit-notice-for-all', $value->id) }}"
                                                        class="btn btn-sm btn-primary me-2"
                                                        style="color:white !important; ">
                                                        <i class="feather-edit"></i></a>
                                                    <a href="{{ 'remove-notice/' . $value->id }}"
                                                        class="btn btn-sm btn-danger me-2"style="color:white !important;">
