                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <input type="text" value="" name="student_id" hidden>
                                                <input type="text" value="" name="class_id" hidden>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('subject_total') is-invalid @enderror"
                                                        name="subject_total" placeholder="Enter Total Subject"
                                                        value="" id="">
                                                    @error('')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
