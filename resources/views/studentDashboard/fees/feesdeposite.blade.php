                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('updateDepositeFees') }}" method="POST">
                                ...
                                <div class="row mb-4 mt-0">
                                    <div class="col-4">
                                        <h5 class="text-danger"  style="text-align: center;">Class {{ Custom::getClass($studentEdit->class_id)->classname}}</h5>
                                    </div>
                                    <div class="col-4">
                                        <h4 class="text-center"> Fees Info </h4>
                                    </div>
                                    <div class="col-4">
                                        <h5 class="text-danger" style="text-align: center;">Fees Account No:- {{ $studentEdit->fee_account}}</h5>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row d-flex justify-content-center"
                                                            ...
                                                            @if ($fees->total_installment == 0)
                                                                <div class="col-1 col-sm-1"
                                                                    style="margin-bottom:15px; margin-left:25px; margin-right:25px;">
                                                            ...
                                                            @else
                                                                @php
                                                                    $totallInstallment =
                                                                        $fees->fees_amount / $fees->total_installment;
