            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Update Session</h3>
                            <ul class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('update-session') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control @error('session') is-invalid @enderror" name="session" value="{{ $data->session_date }}">
                                                @error('session')
