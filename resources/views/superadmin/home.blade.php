...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-xl-2 col-sm-4 col-12 d-flex">
                    <div class="card bg-comman w-100" style="background-color: rgb(11, 182, 11);">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6 style="color: yellow;">Total Students</h6>
                                    <h3 style="color: rgb(255, 255, 255);">{{ Custom::admintotalStudent()}}</h3>
                                </div>
                                <div >
                ...
                <div class="col-xl-2 col-sm-4 col-12 d-flex">
                    <div class="card bg-comman w-100" style="background-color: rgb(212, 0, 195);">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6 style="color: yellow;">Approved Students</h6>
                                    <h3 style="color: rgb(255, 255, 255);">{{ Custom::adminApprovedStudent() }}</h3>
                                </div>
                                <div >
                ...
                <div class="col-xl-2 col-sm-4 col-12 d-flex">
                    <div class="card bg-comman w-100" style="background-color: rgb(219, 127, 7);">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6 style="color: yellow;">Pending Students</h6>
                                    <h3 style="color: rgb(255, 255, 255);">{{ Custom::adminPendingStudent()}}</h3>
                                </div>
                                <div >
                ...
                <div class="col-xl-2 col-sm-4 col-12 d-flex">
                    <div class="card bg-comman w-100" style="background-color: rgb(147, 57, 250);">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6 style="color: yellow;">Total Staff</h6>
                                    <h3 style="color: rgb(255, 255, 255);">4</h3>
                                </div>
                                <div >
                 ...
                 <div class="col-xl-2 col-sm-4 col-12 d-flex">
                    <div class="card bg-comman w-100" style="background-color: rgb(252, 39, 128);">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6 style="color: yellow;">Total Fees</h6>
                                    <h3 style="color: rgb(255, 255, 255);">{{ Custom::adminschoototalfees()}}</h3>
                                </div>
                                <div >
                ...
                <div class="col-xl-2 col-sm-4 col-12 d-flex">
                    <div class="card bg-comman w-100" style="background-color: rgb(3, 194, 178);">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6 style="color: yellow;">Paid Fees</h6>
                                    <h3 style="color: rgb(255, 255, 255);">{{ Custom::adminschoototalpaidfees() }}</h3>
                                </div>
                                <div >
