    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Online Registration List</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active">Online Registration List</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="student-group-form">
                <form action="{{ route('onlineSearch') }}" method="post">
                    @csrf
                    <div class="row">
                ...
                <div class="modal-body">
                    <form action="{{ route('schoolDelete') }}" method="POST">
                        ...
                        <div class="delete-wrap text-center">
                            ...
                            <h5 style="color:rgb(107, 107, 107)">Sure you want to delete ?</h5>
